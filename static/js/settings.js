...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (deleteAccountButton) {
    deleteAccountButton.addEventListener('click', function(e) {
      e.preventDefault();
      if (confirm("Are you sure you want to request account deletion? This action cannot be undone and will require admin verification.")) {
        ...
        .then(response => {
          if (!response.ok) throw new Error('Failed to submit account deletion request');
          return response.json();
        })
        .then(data => {
